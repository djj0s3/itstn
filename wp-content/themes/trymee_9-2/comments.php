...
?>
<aside id="comments">
	<h4><?php comments_number(__('No Comments', 'cmsmasters'), __('Comment', 'cmsmasters') . ' (1)', __('Comments', 'cmsmasters') . ' (%)'); ?></h4>
...
?>
	<aside id="respond">
        ...
        <h4><?php comment_form_title(__('Leave a Reply', 'cmsmasters'), __('Leave your comment to', 'cmsmasters').' %s'); ?></h4>
    <?php 
